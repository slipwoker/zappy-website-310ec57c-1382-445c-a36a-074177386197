document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (minLength && value.length < parseInt(minLength, 10)) {
        showError(field, field.dataset.errorMinlength || 'Minimum length is ' + minLength + ' characters.');
        return false;
      }

      if (maxLength && value.length > parseInt(maxLength, 10)) {
        showError(field, field.dataset.errorMaxlength || 'Maximum length is ' + maxLength + ' characters.');
        return false;
      }
  ...
  if (animatedElements.length > 0) {
    ...
    function applyAnimationStyles(el) {
      ...
      const duration = el.dataset.animateDuration || '600';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '310ec57c-1382-445c-a36a-074177386197',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '310ec57c-1382-445c-a36a-074177386197';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '310ec57c-1382-445c-a36a-074177386197';
